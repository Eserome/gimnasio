...
CREATE TABLE IF NOT EXISTS `gimnasio`.`cliente_has_ejercicio` (
  ...
  INDEX `fk_cliente_has_ejercicio_ejercicio1_idx` (`ejercicio_id` ASC) VISIBLE,
  INDEX `fk_cliente_has_ejercicio_cliente_idx` (`cliente_id` ASC) VISIBLE)
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;
