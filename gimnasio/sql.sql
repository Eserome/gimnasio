...
-- -----------------------------------------------------
-- Table `gimnasio`.`cliente_SEQ`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gimnasio`.`cliente_SEQ` (
...
-- -----------------------------------------------------
-- Table `gimnasio`.`ejercicio_SEQ`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gimnasio`.`ejercicio_SEQ` (
  `next_val` BIGINT(20) NULL DEFAULT NULL)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_unicode_ci;
